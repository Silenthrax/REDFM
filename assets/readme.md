...
```console
Global.jpg - This image is going to be used by /ping command
```
- > If you want to change ping image, make sure your file name "Global.jpg" remains same or alternatively you can add a var <br><br> `PING_IMG_URL` - Use telegraph link
...
```console
Global.jpg and Global.jpg - This image is going to be used by /stats command
```
- > If you want to change stats images, make sure your file name "Global.jpg" or "Global.jpg" remains same or alternatively you can add a var <br><br> `GLOBAL_IMG_URL` - Use telegraph link<br> `STATS_IMG_URL` - Use telegraph link
