# This code is written by (C) SILENTHREX bot will send message to log group when someone add
# this bot to new group make sure to star all projects
# Copyright (C) 2021-2025 by SILENTHREX@ Github, < SILENTHREX >.
...
from REDFM.utils.database import delete_served_chat, get_assistant, is_on_off
